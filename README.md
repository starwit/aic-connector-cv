...
The final segment of each configured Redis stream ID is forwarded unchanged as the AI Cockpit decision type name. For example, `stream1:Low confidence` creates a `Low confidence` decision.
